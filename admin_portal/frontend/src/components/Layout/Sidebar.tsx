...
export default function Sidebar() {
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/usage-stats', icon: 'monitoring', label: t('nav.usageStats'), section: 'main' },
    { path: '/content-audit', icon: 'fact_check', label: t('nav.contentAudit'), section: 'main' },
    { path: '/content-audit-history', icon: 'inventory_2', label: t('nav.contentAuditHistory'), section: 'main' },
